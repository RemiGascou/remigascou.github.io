<html>
	...
	<section style="padding-top:10%; background:url('/meta/img/LAB/LAB_header_img.jpg') no-repeat center; -webkit-background-size: cover; background-size: cover; width:101.5%; height:100%;" class="container-fluid" id="header-section">
	...
	<body>
		...
		<?php
			...
			$sql = "SELECT * FROM articles WHERE category LIKE 'LAB' ORDER BY date_written DESC" ;
